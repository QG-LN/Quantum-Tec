            ...
            <div className="container mx-auto px-4">
                ...
                <div className="flex flex-wrap justify-center">
                    {/*커뮤니티게시판, 튜터링게시판 이동 버튼 list*/}
                        <h5 className="text-2xl font-semibold">사이드바 리스트</h5>
                        ...
                        <nav className="flex flex-col list-none">
                            ...
                            <li className="nav-item">
                                <a className="px-3 py-2 flex items-center text-xl uppercase font-bold leading-snug text-black hover:opacity-75 no-underline" href="/board/2">
                                    <i className="fab fa-facebook-square text-xs leading-lg text-black opacity-75"/>
                                    <span className="ml-2">튜터링</span>
                                </a>
                            </li>
                            <li className="nav-item">
                                <a className="px-3 py-2 flex items-center text-xl uppercase font-bold leading-snug text-black hover:opacity-75 no-underline" href="/board/3">
                                    <i className="fab fa-facebook-square text-xs leading-lg text-black opacity-75"/>
